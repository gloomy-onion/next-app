...
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$api$2f$todos$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
"__TURBOPACK__ecmascript__hoisting__location__";
;
;
;
const TodoPage = ({ pageProps: { todo } })=>/*#__PURE__*/ (0, __TURBOPACK__commonjs__external__react$2f$jsx$2d$dev$2d$runtime__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$Todo$2f$Todo$2e$tsx__$5b$ssr$5d$__$28$ecmascript$29$__["Todo"], {
        todo: todo
    }, void 0, false, {
...
const getServerSideProps = async (context)=>{
    ...
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$api$2f$todos$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["todosRequests"].getTodoById(Number(params.id));
        const { data } = response;
        if (!data) {
            return {
                notFound: true
...
//# sourceMappingURL=src_93fae2._.js.map